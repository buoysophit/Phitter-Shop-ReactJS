  ...
  const socialLinks = [
    {
      name: "Phitter Shop",
      platform: "Facebook",
      href: "https://facebook.com/phittershop",
      icon: (
    ...
    {
      name: "Phitter Cambodia",
      platform: "Instagram",
      href: "https://instagram.com/phittercambodia",
      icon: (
    ...
    },
    {
      name: "Phitter Phone",
      platform: "Telegram",
      href: "https://t.me/phitterphoneshop",
      icon: (
    ...
    <footer className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-600 text-sm">Phitter Shop © 2025. All Rights Reserved</p>
        </div>
      </div>
    </footer>
  )
